...
class labelme2coco(object):
    def __init__(self,labelme_json=[], path="", save_json_path='./instances_train2014.json'):
        '''
    ...
    def image(self,data,num):
        ...
        tmp = data['imagePath']
        tmp =tmp.replace("../tujiao_selected", "/Users/zhuangjunfei/Desktop/tujiao_select/imgs")
        if 'Users' not in tmp:
            tmp = "/Users/zhuangjunfei/Desktop/tujiao_select/imgs/" + tmp 
        print(tmp)
...
if __name__ == '__main__':
    ...
    labelme2coco((labelme_json), path, './instances_train2014.json')